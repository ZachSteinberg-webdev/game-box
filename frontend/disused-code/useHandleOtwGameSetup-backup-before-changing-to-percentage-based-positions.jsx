...
const useHandleOtwGameSetup=(
	...
	setTimeout(()=>{
		...
		const setupGame=(e)=>{
			...
			ballInitialPositionBottom=((gameboardHeight-ballSize)/2)+'px';
			ballInitialPositionLeft=((gameboardWidth-ballSize)/2)+'px';
			ballInitialPositionRight=((gameboardWidth-ballSize)/2)+'px';
			if(gameball){
		...
		const move=(value)=>{
			if(value===1 || value==='ArrowUp'){
				if((parseInt(gameball.style.top)-moveVerticalDistance)<=0){
					...
					gameball.style.bottom=((gameboardHeight-ballSize)+1)+'px';
					...
					gameball.style.bottom=(parseInt(gameball.style.bottom)+moveVerticalDistance)+'px';
				};
				...
				if((parseInt(gameball.style.right)-moveHorizontalDistance)<=0){
					...
					gameball.style.right='-1px';
				}else{
					gameball.style.left=(parseInt(gameball.style.left)+moveHorizontalDistance)+'px';
					gameball.style.right=(parseInt(gameball.style.right)-moveHorizontalDistance)+'px';
				};
				...
				if((parseInt(gameball.style.left)-moveHorizontalDistance)<=0){
					...
					gameball.style.right=((gameboardWidth-ballSize)+1)+'px';
				}else{
					gameball.style.left=(parseInt(gameball.style.left)-moveHorizontalDistance)+'px';
					gameball.style.right=(parseInt(gameball.style.right)+moveHorizontalDistance)+'px';
				};
